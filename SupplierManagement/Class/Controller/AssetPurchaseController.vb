Public Class AssetPurchaseController
    ...
    Public Model As New AssetPurchaseModel
    ...
    'End Function
    Function loaddataDS(ByRef DSHistory As DataSet, ByVal HIstoryCriteria As String) As Boolean
        Dim myret As Boolean = False
        Model = New AssetPurchaseModel
        If Model.LoadData(DSHistory, HIstoryCriteria) Then
            Dim pk(0) As DataColumn
            pk(0) = DS.Tables(0).Columns("id")
            DS.Tables(0).PrimaryKey = pk
            DS.Tables(0).Columns("id").AutoIncrement = True
