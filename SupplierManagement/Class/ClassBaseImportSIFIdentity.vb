...
Public MustInherit Class ClassBaseImportSIFIdentity
    ...
    Private Sub CleanData()
        ...
        If Not IsNothing(_siftx.Current) Then
            _siftx.Filter = String.Format("documentid = {0}", drv.Item("documentid"))
            ...
            If myrecord(i) <> "" Then
                Try
                    If myField(i) <> 0 Then
                        ...
                        sifdrv.BeginEdit()
                        sifdrv.Row.Item("documentid") = docdrv.Item("documentid")
