Imports Npgsql
Public Class PaymentTermEffDateModel
    Implements IModel
    ...
    Public ReadOnly Property FilterField
        Get
            Return "[vendorcode] like '*{0}*' or [vendorname] like '*{0}*' or [shortname] like '*{0}*' or [paymenttermdesc] like '*{0}*' "
        End Get
    End Property
    Public Function LoadData(ByVal DS As DataSet) As Boolean Implements IModel.LoadData
        ...
        Using conn As Object = myadapter.getConnection
            conn.Open()
            Dim sqlstr = String.Format("select pd.vendorcode::text,pd.id,pd.paymenttermid,pd.effectivedate,v.shortname3::text as shortname, v.vendorname,pt.payt || ' - ' || pt.details as paymenttermdesc from doc.paymenttermdate pd" &
    ...
    Public Function save(ByVal obj As Object, ByVal mye As ContentBaseEventArgs) As Boolean Implements IModel.save
        ...
        Using conn As Object = myadapter.getConnection
            ...
            'Update
            Dim sqlstr = "doc.sp_updatepaymenttermdate"
            ...
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Integer, 0, "paymenttermid").SourceVersion = DataRowVersion.Current
            ...
            sqlstr = "doc.sp_insertpaymenttermdate"
            ...
            dataadapter.InsertCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Integer, 0, "paymenttermid").SourceVersion = DataRowVersion.Current
            ...
            sqlstr = "doc.sp_deletepaymenttermdate"
