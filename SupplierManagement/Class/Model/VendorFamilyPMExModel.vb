Imports Npgsql
Public Class VendorFamilyPMExModel
    Implements IModel
    ...
    Public ReadOnly Property FilterField
        Get
            Return "[vendorcode] like '*{0}*' or [vendorname] like '*{0}*' or [shortname] like '*{0}*' or [familyname] like '*{0}*'  or [pm] like '*{0}*'"
        End Get
    End Property
    Public Function LoadData(ByVal DS As DataSet) As Boolean Implements IModel.LoadData
        ...
        Using conn As Object = myadapter.getConnection
            conn.Open()
            Dim sqlstr = String.Format("select vf.id,vf.familyid,vf.vendorcode::text,f.familyname::text,case when vf.familyid = 0  then 'To Be Define' else f.familyid || ' - ' || f.familyname end as familydesc,case when vf.familyid = 0  then 'To Be Define' else mu.username end as pm,v.vendorname::text,v.shortname::text,vf.pmid  from doc.vendorfamilypm vf " &
    ...
    Public Function save(ByVal obj As Object, ByVal mye As ContentBaseEventArgs) As Boolean Implements IModel.save
        ...
        Using conn As Object = myadapter.getConnection
            ...
            'Update
            Dim sqlstr = "doc.sp_updatevendorfamilypm"
            ...
            sqlstr = "doc.sp_insertvendorfamilypm"
            ...
            sqlstr = "doc.sp_deletevendorfamilypm"
