Public Class VendorFamilyPMExAdapter
    Implements IAdapter
    Implements IToolbarAction
    Dim DS As DataSet
    Dim DbAdapter1 As DbAdapter = DbAdapter.getInstance
    Public BS As BindingSource
    Dim VendorFamilyPMModel1 As VendorFamilyPMExModel
    ...
    Public ReadOnly Property GetBindingSource As BindingSource
        Get
            ...
            BS.Sort = VendorFamilyPMModel1.SortField
            Return BS
        End Get
    End Property
    ...
    Public Function LoadData() As Boolean Implements IAdapter.loaddata
        ...
        VendorFamilyPMModel1 = New VendorFamilyPMExModel
        DS = New DataSet
        If VendorFamilyPMModel1.LoadData(DS) Then
    ...
    Public Property ApplyFilter As String Implements IToolbarAction.ApplyFilter
        ...
        Set(ByVal value As String)
            BS.Filter = String.Format(VendorFamilyPMModel1.FilterField, value)
        End Set
    End Property
    ...
    Public Function Save(ByVal mye As ContentBaseEventArgs) As Boolean Implements IToolbarAction.Save
        Dim myret As Boolean = False
        If VendorFamilyPMModel1.save(Me, mye) Then
            myret = True
        End If
        Return myret
    End Function
