Imports System.Text
Public Class VendorCurrAdapter
    Implements IAdapter
    Implements IToolbarAction
    Dim DS As DataSet
    Dim DbAdapter1 As DbAdapter = DbAdapter.getInstance
    Public BS As BindingSource
    'Dim VendorCurrModel1 As VendorCurrModel
    Dim myModel As New VendorCurrModel

    Public ReadOnly Property GetTableVendorCurr As DataTable
        Get
            Return DS.Tables("vendorcurr").Copy()
        End Get
    End Property
    ...
    Public ReadOnly Property GetBindingSource As BindingSource
        Get
            ...
            BS.DataSource = GetTableVendorCurr
    ...
    Public Function LoadData() As Boolean Implements IAdapter.loaddata
        ...
        'VendorCurrModel1 = New VendorCurrModel
        DS = New DataSet
    ...
    Public Function getLatesVendorCurr(ByVal vendorcode As Long) As String
        Return myModel.getLatesVendorCurr(vendorcode)
    End Function
End Class
