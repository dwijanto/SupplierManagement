Imports System.Text
Public Class ToolingSupplierAdapter
    Implements IAdapter
    Implements IToolbarAction
    Dim DS As DataSet
    Dim DbAdapter1 As DbAdapter = DbAdapter.getInstance
    Public BS As BindingSource
    Dim myModel As New ToolingSupplierModel

    Public ReadOnly Property GetToolingSupplierBS As BindingSource
        Get
            Return myModel.GetToolingSupplierBS
        End Get
    End Property
