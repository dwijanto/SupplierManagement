Imports System.Text
Public Class SubFamilyVCAdapter
    Implements IAdapter
    Implements IToolbarAction
    Dim DS As DataSet
    Dim DbAdapter1 As DbAdapter = DbAdapter.getInstance
    Public BS As BindingSource
    Dim SubFamilyVCModel1 As New SubFamilyVCModel

    Public ReadOnly Property GetTableSubFamilyVC As DataTable
        Get
            Return DS.Tables("subfamilyvc").Copy()
        End Get
    End Property
    ...
    Public ReadOnly Property GetBindingSource As BindingSource
        Get
            ...
            BS.DataSource = GetTableSubFamilyVC
            BS.Sort = SubFamilyVCModel1.SortField
            Return BS
        End Get
    End Property

    Public ReadOnly Property getSubFamilyVCBS As BindingSource
        Get
            Return SubFamilyVCModel1.getSubFamilyVCBS
        End Get
    End Property

    Public Function LoadData() As Boolean Implements IAdapter.loaddata
        Dim myret As Boolean = False
        SubFamilyVCModel1 = New SubFamilyVCModel
        DS = New DataSet
        If SubFamilyVCModel1.LoadData(DS) Then
            Dim pk(0) As DataColumn
            pk(0) = DS.Tables(0).Columns("subfamilyvc")
    ...
    Public Property ApplyFilter As String Implements IToolbarAction.ApplyFilter
        ...
        Set(ByVal value As String)
            BS.Filter = String.Format(SubFamilyVCModel1.FilterField, value)
        End Set
    End Property
    ...
    Public Function Save(ByVal mye As ContentBaseEventArgs) As Boolean Implements IToolbarAction.Save
        Dim myret As Boolean = False
        If SubFamilyVCModel1.save(Me, mye) Then
            myret = True
        End If
        Return myret
    End Function
