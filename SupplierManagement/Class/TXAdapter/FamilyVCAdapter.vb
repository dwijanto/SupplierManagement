...
Public Class FamilyVCAdapter
    ...
    Public ReadOnly Property GetTableFamilyVC As DataTable
        Get
            Return DS.Tables("familyvc").Copy()
        End Get
    End Property
    ...
    Public Function LoadData() As Boolean Implements IAdapter.loaddata
        ...
        FamilyVCModel1 = New FamilyVCModel
        DS = New DataSet
        If FamilyVCModel1.LoadData(DS) Then
            Dim pk(0) As DataColumn
            pk(0) = DS.Tables(0).Columns("familyvc")
    ...
    Public Property ApplyFilter As String Implements IToolbarAction.ApplyFilter
        ...
        Set(ByVal value As String)
            BS.Filter = String.Format(FamilyVCModel1.FilterField, value)
        End Set
    End Property
    ...
    Public Function Save(ByVal mye As ContentBaseEventArgs) As Boolean Implements IToolbarAction.Save
        Dim myret As Boolean = False
        If FamilyVCModel1.save(Me, mye) Then
            myret = True
        End If
        Return myret
    End Function
