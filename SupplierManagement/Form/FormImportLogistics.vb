...
Public Class FormImportLogistics
    ...
    Private Sub doWork()
        Try
                        ...
                        If count >= 1 Then
                            If IsNumeric(myrecord(0)) Then
                                ...
                                If myrecord(0) >= String.Format("{0:yyyyMM}", period1) And myrecord(0) <= String.Format("{0:yyyyMM}", period2) Then
                                    ...
                                    'period,year,fpcp,vendorcode,sbu,cmmf,orderno,shipment,leadtime,sasl,ssl,weight
            ...
            If myInsert.Length > 0 Then
                ...
                mystr.Append(String.Format("delete from doc.logistics where period >= {0:yyyyMM} and period <= {1:yyyyMM};", period1, period2))
                Dim sqlstr As String = "copy doc.logistics(period,year,fpcp,vendorcode,sbu,cmmf,orderno,shipment,leadtime,sasl,ssl,weight,sslnet) from stdin with null as 'Null';"
                Dim ra As Long = 0
                ...
                Try
                    ...
                    If myret Then
                        DbAdapter1.setaudit("Logistics", HelperClass1.UserInfo.userid)
    ...
    Private Sub doDelete()
        Dim sqlstr = String.Format("delete from doc.logistics where period >= {0:yyyyMM} and period <= {1:yyyyMM}", DateTimePicker1.Value, DateTimePicker2.Value)
        Dim mymessage As String = String.Empty
    ...
    Private Sub FormImportLogistics_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
