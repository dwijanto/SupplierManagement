...
Public Class FormVendorPM
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myController As VendorPMAdapter
    ...
    Public Sub New()
        ...
        RemoveHandler DialogVendorPM.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogVendorPM.RefreshDataGridView, AddressOf RefreshDataGridView
    End Sub
    ...
    Sub DoWork()
        myController = New VendorPMAdapter
    ...
    Public Sub showTx(ByVal tx As TxEnum)
        If Not myThread.IsAlive Then
            ...
            Me.drv.BeginEdit()
            Dim myform = New DialogVendorPM(drv, VendorBS, VendorHelperBS, PMBS, PMHelperBS)
            myform.ShowDialog()
        End If
