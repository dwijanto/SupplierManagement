...
Public Class FormModificationTypeMaster
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myController As ModificationTypeController
    ...
    Sub DoWork()
        myController = New ModificationTypeController
    ...
    Public Sub showTx(ByVal tx As TxEnum)
        If Not myThread.IsAlive Then
            ...
            Me.drv.BeginEdit()
            Dim myform = New DialogModificationTypeMaster(drv)
            myform.ShowDialog()
        End If
    ...
    Private Sub ToolStripButton6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton6.Click
        Dim myform As New DialogReguiredDocument(myController.BSDTL, myController.DocTypeBS)
        'myform.ShowDialog()
        myform.Show()
    End Sub
