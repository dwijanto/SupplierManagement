...
Public Class DialogSupplyChainOther
    ...
    Private Sub initialDataRow()
        TextBox1.DataBindings.Add(New Binding("Text", DRV, "leadtime", False, DataSourceUpdateMode.OnPropertyChanged, ""))
        TextBox2.DataBindings.Add(New Binding("Text", DRV, "sasl", False, DataSourceUpdateMode.OnPropertyChanged, ""))
