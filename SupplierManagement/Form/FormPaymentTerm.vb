...
Public Class FormPaymentTerm
    Dim myThread As New System.Threading.Thread(AddressOf DoWork)
    Dim myController As PaymentTermAdapter
    ...
    Public Sub New()
        ...
        RemoveHandler DialogPaymentTerm.RefreshDataGridView, AddressOf RefreshDataGridView
        AddHandler DialogPaymentTerm.RefreshDataGridView, AddressOf RefreshDataGridView
    ...
    Sub DoWork()
        myController = New PaymentTermAdapter
    ...
    Public Sub showTx(ByVal tx As TxEnum)
        If Not myThread.IsAlive Then
            ...
            Dim myform = New DialogPaymentTerm(drv)
            myform.ShowDialog()
        End If
