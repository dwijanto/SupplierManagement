...
Public Class FormImportProjectStatus
    ...
    Private Sub doWork()
        Try
            ...
            If myInsert.Length > 0 Then
                ...
                mystr.Append(String.Format("delete from doc.pdproject where period >= {0:yyyyMM} and period <= {1:yyyyMM};", period1, period2))
                Dim sqlstr As String = "copy doc.pdproject(period,year,fpcp,shortname,rp4,rp5,noofproject,projectontime) from stdin with null as 'Null';"
                Dim ra As Long = 0
                ...
                Try
                    ...
                    If myret Then
                        DbAdapter1.setaudit("ProjectStatus", HelperClass1.UserInfo.userid)
    ...
    Private Sub doDelete()
        Dim sqlstr = String.Format("delete from doc.pdproject where period >= {0:yyyyMM} and period <= {1:yyyyMM}", DateTimePicker1.Value, DateTimePicker2.Value)
        Dim mymessage As String = String.Empty
