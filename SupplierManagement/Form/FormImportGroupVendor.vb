...
Public Class FormImportGroupVendor
    ...
    Private Sub doWork()
        ...
        If myInsert.Length > 0 Then
            ...
            mystr.Append(String.Format("delete from doc.groupvendor where groupid = {0};", groupid))
            ...
            Try
                ...
                If myret Then
                    DbAdapter1.setaudit("GroupVendor", HelperClass1.UserInfo.userid)
