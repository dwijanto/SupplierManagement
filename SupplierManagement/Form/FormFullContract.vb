...
Public Class FormFullContract
    ...
    Private Sub Button10_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button10.Click
        ...
        If RadioButton1.Checked Then
            ...
            sb.Append(" from doc.contractlatestallvendor(" & latestdate & "::date) clt")
        Else
            startdate = "'" & Year(DateTimePicker2.Value) & "-1-1'"
            enddate = "'" & Year(DateTimePicker3.Value) & "-12-31'"
            'nonblankdoc = " and not d.id isnull "
            sb.Append(" from doc.contractdetailallvendor(" & startdate & "::date," & enddate & "::date) clt")
        End If
        ...
        If TextBox6.Text <> "" Then
            ...
            'sb.Append(" and pdt.producttype::text ='" & TextBox6.Text.Replace("'", "''") & "'")
        End If
        ...
        If (mysaveform.ShowDialog() = Windows.Forms.DialogResult.OK) Then
            ...
            'Dim myreport As New ExportToExcelFile(Me, sqlstr, filename, reportname, mycallback, PivotCallback, datasheet, "\\172.22.10.44\SharedFolder\PriceCMMF\New\template\SupplierDocumentTemplate.xltm")
            Dim myreport As New ExportToExcelFile(Me, sqlstr, filename, reportname, mycallback, PivotCallback, datasheet, String.Format("{0}\SupplierDocumentTemplate.xltm", HelperClass1.template))
