                ...
                Select Case id
                    ...
                    Case 4
                        Try
                            ...
                            pk(0) = DS.Tables(0).Columns("statusid")
                            DS.Tables(0).PrimaryKey = pk
                            DS.Tables(0).Columns("statusid").AutoIncrement = True
                            DS.Tables(0).Columns("statusid").AutoIncrementSeed = 0
                            DS.Tables(0).Columns("statusid").AutoIncrementStep = -1
                            DS.Tables(0).TableName = "Status"
                            ...
                            TextBox1.DataBindings.Add(New Binding("Text", SCBS, "status", True, DataSourceUpdateMode.OnPropertyChanged, ""))
        ...
        If Me.validate Then
            Try
                ...
                If Not IsNothing(ds2) Then
                    ...
                    If Not DbAdapter1.StatusTx(Me, mye) Then
