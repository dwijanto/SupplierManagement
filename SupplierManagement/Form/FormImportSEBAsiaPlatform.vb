...
Public Class FormImportSEBAsiaPlatform
    ...
    Private Sub doWork()
        Try
                    ...
                    Do Until .EndOfData
                        ...
                        If count >= 1 Then
                            If IsNumeric(myrecord(0)) Then
                                myInsert.Append(validlong(myrecord(0)) & vbCrLf)
                            End If
                        End If
                        count += 1
                    Loop
            ...
            If myInsert.Length > 0 Then
                ...
                mystr.Append(String.Format("delete from doc.sebplatform ;"))
                Dim sqlstr As String = "copy doc.sebplatform(cmmf) from stdin with null as 'Null';"
                Dim ra As Long = 0
                ...
                Try
                    ...
                    If myret Then
                        DbAdapter1.setaudit("SEBAsiaPlatform", HelperClass1.UserInfo.userid)
