...
Public Class FormImportCitiProgram
    ...
    Private Sub doWork()
        Try
                    ...
                    Do Until .EndOfData
                        ...
                        If count >= 1 Then
                            If IsNumeric(myrecord(0)) Then
                                myInsert.Append(validlong(myrecord(0)) & vbTab &
                                                validstr(myrecord(1)) & vbTab &
                                                DateFormatyyyyMMddString(myrecord(2)) & vbTab &
                                                validstr(myrecord(3)) & vbTab &
                                                DateFormatyyyyMMddString(myrecord(4)) & vbCrLf)
                            End If
                        End If
                        count += 1
                    Loop
            ...
            If myInsert.Length > 0 Then
                ...
                mystr.Append(String.Format("delete from doc.citiprogram ;"))
                Dim sqlstr As String = "copy doc.citiprogram(vendorcode,fpcp,joindate,crcy,enddate) from stdin with null as 'Null';"
                Dim ra As Long = 0
