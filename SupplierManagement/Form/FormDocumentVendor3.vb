...
Public Class FormDocumentVendor3
    ...
    Sub DoWork()
        ...
        'sb.Append(String.Format("select go.*,vd.id as vdid from doc.generalcontractother go left join doc.vendordoc vd on vd.documentid = go.documentid " &
        '          " where vd.headerid = {0} order by go.otherdate;", headerid))
        ''SupplyChainOther
        'sb.Append(String.Format("select so.*,vd.id as vdid from doc.supplychainother so left join doc.vendordoc vd on vd.documentid = so.documentid " &
        ...
        '          " where vd.headerid = 1107 order by qo.otherdate", headerid))
                ...
                Select Case id
                    ...
                    Case 4
                        Try
                            ...
                            'sodocid(0) = DS.Tables(12).Columns("vdid")
                            'sodocid(1) = DS.Tables(12).Columns("documentid")
                            ...
                            'qodocid(0) = DS.Tables(12).Columns("vdid")
                            'qodocid(1) = DS.Tables(12).Columns("documentid")
